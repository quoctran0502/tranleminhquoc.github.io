...
<figure>
  <img src="/images/5-Workshop/5.2-VPC-RDS/image15.png" alt="Cấu hình kết nối" style="max-width:100%;height:auto;" />
  <figcaption><em>Cấu hình kết nối riêng tư và bảo mật</em></figcaption>
</figure>
...
3. **Public access**: Chọn **No** (Việc đặt Public access = No giúp RDS không thể truy cập trực tiếp từ Internet).
